...
var cBhtGroundTemp = new chartSet();
...
function GoogleCharts_onload() {
    ...
    console.log('Compass');
    $.getScript("compass/compass.js", Compass_onload);
}
...
function setupDataAndCharts(result) {
    ...
    setupCharts();
    setTimeout(loadData,
               NumberOfSecondsBetweenReloadingData * 1000,
               updateDataAndCharts
    );
}
...
function setupData(result) {
    ...
    if(typeof obj=="undefined"){
        var obj={};
        obj.AMBIENT_TEMPERATURE=45;
        obj.GROUND_TEMPERATURE=20;
        obj.HUMIDITY=20;
        obj.WIND_DIRECTION=2;
        obj.AIR_PRESSURE=5;
    }
...
debugger;
    ...
    intPdebugger;ressure = obj.AIR_PRESSURE;
debugger;
...
function setupCharts() {
    ...
    drawChart(chtTemp, "chart_ground_temp", "Ground temp", intGroundTemperature);
